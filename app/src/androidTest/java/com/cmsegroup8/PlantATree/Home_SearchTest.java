...
public class Home_SearchTest {

    @Rule
    public ActivityTestRule<Home> mActivityTestRule = new ActivityTestRule<>(Home.class);

    @Test
    public void home_SearchTest() {
        ViewInteraction frameLayout = onView(allOf(withId(R.id.navigation_Search), withContentDescription("Search"), childAtPosition(childAtPosition(withId(R.id.bottomNavView_Bar), 0), 1), isDisplayed()));
